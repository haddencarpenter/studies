...
-- AlterTable
ALTER TABLE "Coin" ADD COLUMN     "launch_date_end" TIMESTAMP(3),
ADD COLUMN     "launch_date_start" TIMESTAMP(3),
ADD COLUMN     "launch_price" DECIMAL(65,30);

-- CreateTable
CREATE TABLE "DropsTab" (
    "id" SERIAL NOT NULL,
    "url" TEXT NOT NULL,
    "symbol" TEXT NOT NULL,

    CONSTRAINT "DropsTab_pkey" PRIMARY KEY ("id")
);
